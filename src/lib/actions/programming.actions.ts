...
import { buildSingleSessionSystemPrompt, buildSingleSessionUserPrompt } from '@/lib/ai/prompts/programming'
import type { PreviousWeekSession, SingleSessionContext, ExistingPoolSession } from '@/lib/ai/prompts/programming'
import { autoAssignSessionDates, findOptimalDayForSession } from '@/lib/scheduling/auto-assign'
// Persistence helpers + benchmark dedup relocated to engine layer in Task 12
