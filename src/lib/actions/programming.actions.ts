...
import { WeeklySessionPoolSchema, SingleSessionResponseSchema, createValidatedSessionPoolSchema } from '@/lib/ai/schemas/programming'
import type { WeeklySessionPool, Session, LiftingSession, EnduranceSession, ConditioningSession, MobilitySession, SingleSessionResponse } from '@/lib/ai/schemas/programming'
...
// buildMethodologyContext relocated to engine/_shared in Task 10 of the engine refactor
